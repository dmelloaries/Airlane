  ...
  return {
    ...
    computed: {
      corridor_a: {
        ...
        hazard_exposure: {
          ...
          min_transmission_distance_m: 120.5,
        ...
        obstacles: [
          {
            ...
            obstacle_type: "115kV Transmission Line",
            distance_m: 120.5,
            voltage_kv: 115,
            severity: "HIGH",
        ...
        landing_zones: [
          {
            ...
            infrastructure_clearance_m: 1968.0,
            slope_degrees: 3.2,
            elevation_m: 12.4,
            fema_flood_zone: "X",
            source: "Airlane BVLOS Terrain Engine",
            description: "LZ-01: Designated Primary Emergency Landing Zone",
          },
          {
            sample_index: 1,
            lat: 37.4240,
            ...
            infrastructure_clearance_m: 1280.5,
            slope_degrees: 1.0,
            elevation_m: 9.8,
            fema_flood_zone: "X",
            source: "Airlane BVLOS Terrain Engine",
            description: "LZ-02: Backup Emergency Landing Zone",
          },
        ],
      },
      corridor_b: {
        ...
        hazard_exposure: {
          ...
          min_substation_distance_m: 310.0,
          total_samples: 12,
          points_under_150m: 1,
          points_under_500m: 4,
        },
        ...
        obstacles: [
          {
            ...
            obstacle_type: "Transmission Tower #4B",
            distance_m: 42.1,
            voltage_kv: 115,
            severity: "HIGH",
            clearance_status: "CRITICAL PROXIMITY (<45m)",
            source: "Mireye Earth API",
            description: "Passes within 42.1m of transmission tower #4B, exceeding electromagnetic safety thresholds.",
          },
        ],
        landing_zones: [],
      },
      ...
      comparison: {
        ...
        rejected_corridors: [
          { id: "corridor_b", name: "Corridor Beta", reason: "Passes within 42.1m of transmission tower #4B (Critical Proximity)." },
    ...
    safety_case: {
      ...
      primary_justification:
        "Corridor Alpha maintains verified 120.5m lateral clearance from transmission infrastructure, operates 100% within FAA 400ft Class D airspace ceilings, and avoids dense population clusters.",
      rejected_corridors: [
        { id: "corridor_b", name: "Corridor Beta", reason: "Passes within 42.1m of transmission tower #4B (Critical Proximity)." },
      ...
      flagged_risks: [
        "115kV Transmission Line (Mireye Earth API): 120.5m clearance maintained via lateral detour.",
      ],
...
export default function App() {
  ...
  const executeSimulatedPipeline = (payload: MissionInputPayload) => {
    const simSteps: Array<Omit<TraceEvent, "timestamp">> = [
      ...
      {
        step: "data_ingestion",
        message: "✓ Multi-Source Ingestion: Ingested transmission grid infrastructure, FAA UASFM grids, Census tracts, and NOAA METAR station feeds in parallel",
        status: "complete",
        category: "sensor",
        level: "info",
      ...
      {
        step: "mireye_hazards",
        message: "✓ Mireye Earth API: Overhead transmission line detected. Corridor Alpha enforces 120.5m lateral buffer (>60m requirement)",
        status: "complete",
        category: "sensor",
        level: "warning",
        source_name: "Mireye Earth API",
        agent_thought: "Identified overhead transmission tower #3A near mile 0.88. Corridor Alpha detour maintains 120.5m lateral clearance, avoiding electro-magnetic lockout.",
        elapsed_ms: 840,
        obstacle_count: 1,
        corridor_id: "corridor_a",
        metrics: {
          voltage_kv: 115,
          min_clearance_m: 120.5,
      ...
      {
        step: "compute_engine",
        message: "✓ Compute Engine: Deterministic ranking complete — Corridor Alpha ranked #1. Emergency Forced-Landing Sites verified.",
        status: "complete",
        category: "compute",
        level: "success",
